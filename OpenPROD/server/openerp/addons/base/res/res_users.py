...
class res_users(osv.osv):
    ...
    _columns = {
        ...
        'partner_id': fields.many2one('res.partner', required=False,
            string='Related Partner', ondelete='set null',
        ...
        'color': fields.integer('Color Index'),
        # Champ pour authoriser l'utilisateur à changer son mot de passe
        'can_change_password': fields.boolean('Can change password', default=True),
    }
