...
class ir_translation(osv.osv):
    ...
    def _get_source_query(self, cr, uid, name, types, lang, source, res_id, module):
        if source:
    ...
    @tools.ormcache('name', 'types', 'lang', 'source', 'res_id', 'module')
    def __get_source(self, cr, uid, name, types, lang, source, res_id, module):
        # res_id is a tuple or None, otherwise ormcache cannot cache it!
        query, params = self._get_source_query(cr, uid, name, types, lang, source, res_id, module)
    ...
    def _get_source(self, cr, uid, name, types, lang, source=None, res_id=None, module=None):
        """
        ...
        if res_id:
            if isinstance(res_id, (int, long)):
                ...
                res_id = tuple(res_id)
        return self.__get_source(cr, uid, name, types, lang, source, res_id, module)
