...
class Sentinel(object):
    ...
    def _input_text_error(self, message, default='', size=None, title=None):
        """
        ...
        while True:
            ...
            self._display(display_value, 0, line, color='error', modifier=curses.A_BOLD)
            key = self._display(message, scroll=True, color='error', bgcolor=True, height=self.window_height - 1, cursor=(line, min(len(value), self.window_width - 1)), title=title)
