...
class res_partner(osv.osv):
    ...
    _columns = {
        'property_account_payable_id': fields.many2one(
           'account.account', 'Account Payable',  ondelete='restrict',
            domain="[('type', '=', 'payable')]",
            help="This account will be used instead of the default one as the payable account for the current partner",
            required=False, oldname="property_account_payable"),
        'property_account_receivable_id': fields.many2one(
           'account.account', 'Account Receivable', ondelete='restrict',
            domain="[('type', '=', 'receivable')]",
            help="This account will be used instead of the default one as the receivable account for the current partner",
            required=False, oldname="property_account_receivable"),
        'property_account_position_id': fields.many2one(
           'account.fiscal.position', 'Fiscal Position',  ondelete='restrict',
            help="The fiscal position will determine taxes and accounts used for the partner.",
            required=False, oldname="property_account_position"),
        'property_payment_term_id': fields.many2one(
           'account.payment.term', 'Customer Payment Term',  ondelete='restrict',
            help="This payment term will be used instead of the default one for sale orders and customer invoices",
            required=False, oldname="property_payment_term"),
        'property_supplier_payment_term_id': fields.many2one(
           'account.payment.term', 'Supplier Payment Term',  ondelete='restrict',
            help="This payment term will be used instead of the default one for purchase orders and supplier invoices",
            required=False, oldname="property_supplier_payment_term"),
