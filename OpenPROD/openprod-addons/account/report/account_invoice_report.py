...
class account_invoice_report(osv.osv):
    ...
    _depends = {
        'account.invoice': [
            'account_id', 'amount_total', 'company_id',
        ...
        'product.uom': ['category_id', 'factor', 'name'],
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.date, sub.product_id, sub.partner_id, sub.country_id,
                sub.payment_term_id, sub.period_id, sub.currency_id, sub.journal_id,
    ...
    def _sub_select(self):
        select_str = """
                SELECT min(ail.id) AS id,
                    ...
                    ail.product_id, ai.partner_id, ai.payment_term_id, ai.period_id,
                    ai.currency_id, ai.journal_id, ai.fiscal_position_id, ai.user_id, ai.company_id,
                    count(ail.*) AS nbr,
                    ai.type, ai.state, ai.date_due, ai.account_id, ail.account_id AS account_line_id,
                    ai.partner_bank_id,
                    SUM(CASE
    ...
    def _group_by(self):
        group_by_str = """
                GROUP BY ail.product_id, ai.date_invoice, ai.id,
                    ai.partner_id, ai.payment_term_id, ai.period_id, ai.currency_id, ai.journal_id,
                    ai.fiscal_position_id, ai.user_id, ai.company_id, ai.type, ai.state,
                    ai.date_due, ai.account_id, ail.account_id, ai.partner_bank_id, ai.residual,
                    ai.amount_total, partner.country_id
        """
        return group_by_str
