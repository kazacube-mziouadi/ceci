...
class mail_thread(osv.osv):
    ...
    _columns = {
        'message_ids': fields.one2many('mail.mail', 'res_id', 'Messages', readonly=True),
    }
    ...
    def message_append(self, cr, uid, threads, subject, body_text=None, email_to=False,
                ...
                original=None, parse_content_id=None, context=None):
        ...
        for thread in threads:
            ...
            for attachment in attachments:
                ...
                if parse_content_id and fname in parse_content_id and parse_content_id[fname]:
                    data_attach['parse_content_id'] = parse_content_id[fname]
            ...
            if 'mail_import_fetchmail' in context and context['mail_import_fetchmail']:
                data['mail_import_fetchmail'] = context['mail_import_fetchmail']
                
            mail_mail.create(cr, uid, data, context=context)
        return True
    ...
    def message_append_dict(self, cr, uid, ids, msg_dict, context=None):
        ...
        return self.message_append(cr, uid, ids,
                            ...
                            parse_content_id= msg_dict.get('parse_content_id'),
                            context = context)
    ...
    def message_process(self, cr, uid, model, message, custom_values=None,
        ...
        if 'list_name_no_create_crm_document' in msg:
            context['list_name_no_create_crm_document'] = msg['list_name_no_create_crm_document']
            del msg['list_name_no_create_crm_document']        
        ...
        if not res_id:
            if 'subject' not in msg:
                match = False
                msg['subject'] = _('Without subject')
            else:
                match = tools.res_re.search(msg['subject']) or False
        ...
        if 'mail_in_no_forward' in context and context['mail_in_no_forward']:
            pass
        else:
    ...
    def message_forward(self, cr, uid, model, thread_ids, msg, email_error=False, context=None):
        ...
        for res in model_pool.browse(cr, uid, thread_ids, context=context):
            ...
            if forward_to:
                ...
                try:
                    message_id = smtp_server_obj.send_email(cr, uid, msg)
                except:
                    message_id = False
                    
                if not message_id and email_error:
                    subj = msg['Subject']
