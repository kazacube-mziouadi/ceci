...
var DataExport = Dialog.extend({
    ...
    start: function() {
        ...
        this.$el.parent('.modal-content').css('max-height', 'inherit');
    ...
    show_exports_list: function() {
        ...
        return this.exports.read_slice(['name'], {
            ...
            var can_delete = (sec_rule === true) || (_.isObject(sec_rule) && sec_rule.is_admin);
            self.$el.find('#ExistsExportList').append(QWeb.render('Exists.ExportList', {'existing_exports': export_list, 'can_delete':can_delete}));
    ...
    on_click_export_data: function() {
        ...
        if (this.$el.find('#export_id').is(':checked')) {
        ...
        this.session.get_file({
            ...
            data: {data: JSON.stringify({
                ...
                header_type: this.$el.find('#header_type').val(),
            })},
