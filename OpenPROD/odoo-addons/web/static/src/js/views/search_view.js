...
var SearchView = Widget.extend(/** @lends instance.web.SearchView# */{
    ...
    init: function(parent, dataset, view_id, defaults, options) {
        ...
        this.view_id = view_id; // id de la vue sur lequel s'applique la recherche
    ...
    /**
     * Extract search data from the view's facets.  !! not from this.query ???
     *
    ...
    /**
     * @param {openerp.web.search.SearchQuery | undefined} Undefined if event is change  !!! ATENTION collection n'est plus utilisé dans la v9, des restes d'une ancienne version passer par this.query
