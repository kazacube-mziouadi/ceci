...
var FieldFloat = FieldChar.extend({
    ...
    set_value: function(value_) {
        if (value_ !== false && this.digits !== undefined && this.digits.length === 2) {
    ...
    initialize_content: function() {
        if (!this.get("effective_readonly")) {
            ...
            this.datewidget.on('datetime_changed', this, _.bind(function() {
                //this.internal_set_value(formats.format_value(this.datewidget.get_value(), {widget:this.datewidget.type_of_date}));
