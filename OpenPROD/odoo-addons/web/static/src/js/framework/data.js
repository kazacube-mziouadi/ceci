...
var BufferedDataSet = DataSetStatic.extend({
    ...
    reset_ids: function(ids, options) {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        //                    voir https://bugs.launchpad.net/openerp-web/+bug/1248531                   //
        ///////////////////////////////////////////////////////////////////////////////////////////////////
...
function compute_domain (expr, fields) {
    ...
    for (var i = expr.length - 1; i >= 0; i--) {
        ...
        // normalize x2many value for deleted values when dataset is not saved yet
        if (field_value instanceof Array) {
            field_value = _.filter(field_value, function(command) {
                if (command instanceof Array && command.length == 3 && command[0] in [2,3,5]) {
                    return false;
                }
                return true;
            });
