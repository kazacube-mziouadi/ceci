...
(function(window){
    ...
    function GraphEdge(graph,label,start,end,tmp,color){
        var self = this;
        var r = graph.r;
        ...
        update_curve();
        var edge = r.path(edge_path).attr({ 'stroke':       color || graph.style.edge_color, 
        ...
        this.set_selected = function(){
            if(!selected){
                selected = true;
                edge.attrs.old_stroke = edge.attrs.stroke;
        ...
        this.set_not_selected = function(){
            if(selected){
                selected = false;
                edge.animate({  'stroke':       edge.attrs.old_stroke || graph.style.edge_color,
