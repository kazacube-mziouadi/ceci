...
var ViewEditor = Widget.extend({
    ...
    do_node_add: function(side){
        ...
        _.each([tr, parent_tr],function(element) {
            var value = _.has(_CHILDREN, element) ? element : _.str.include(html_tag, element)?"html_tag": (element == 'xpath')?element:false;
        ...
        this.add_node_dialog = new Dialog(this,{
            ...
            buttons: [
                {text: _t("Update"), click: function() {
                   ...
                   check_add_node = (values.position == "Inside")?
                    (_.include(_CHILDREN[properties[0]],values.node_type) || properties[0] == 'xpath')?true:false:
                    (_.include(_CHILDREN[properties[1]],values.node_type) || properties[1] == 'xpath')?true:false;
